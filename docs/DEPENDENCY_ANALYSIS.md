...
**Status:** Evidence document · Generated 2026-07-07 from a code-level scan of every dependency manifest (`pyproject.toml`, `requirements*.txt`, `package.json`) across the repos in `D:\mem`.
